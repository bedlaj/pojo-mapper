...
public class PojoMapperComponentFromPojoTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            public void configure() {
                ...
                from("direct:throw")
                        ...
                        .end()
                        .to("pojo-mapper://levelError?throwExceptionOnMissingSource=true")
                        .to("mock:resultThrow");
